...
class Config:
    ...
    num_types = 14  # 标签种类
    num_tag_each_type = 4
    tokenizer = 'chinese-roberta-wwm-ext-large'
    ...
    # ptm：encoder选择的模型
    ptm_model = 'chinese-roberta-wwm-ext-large'  # 'hfl/chinese-roberta-wwm-ext-large'
    ptm_feat_size = 1024
    ...
    # commmon
    flat_in_feat_size = 256
    hidden_size = 256  # out_size
